...
function OptimizationAdvice({ stats }: { stats: PageStats[] }) {
  ...
  for (const page of stats) {
    ...
    // CTA clicks maar geen conversie
    ...
    // Veel WhatsApp clicks = goede engagement
